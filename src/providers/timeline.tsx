...
import { SLOT_MACHINE_TEMPLATE } from "../composition/templates/slot-machine";
import { secondsToFrames } from "../lib/timeline-math";
import { addAudio } from "../lib/timeline-utils/add-audio";
import { addComponent } from "../lib/timeline-utils/add-component";
import { addScene } from "../lib/timeline-utils/add-scene";
import { deleteScene } from "../lib/timeline-utils/delete-scene";
import { editComponent } from "../lib/timeline-utils/edit-component";
import {
  addKeyframeAtFrame,
  removeKeyframe,
  upsertKeyframe,
} from "../lib/timeline-utils/keyframes";
import { patchComponent } from "../lib/timeline-utils/patch-component";
import { removeAudio, updateAudio } from "../lib/timeline-utils/update-audio";
import { updateScene } from "../lib/timeline-utils/update-scene";
